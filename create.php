...
<body>
	...
	<div class="container mt-5">
		...
		<form action="#" method="POST" enctype="multipart/form-data" class="bg-light p-4 rounded">
			...
			<div class="mb-3">
				<label for="iddocumentfile" class="form-label">Upload ID Document Image</label>
				<input type="file" class="form-control" id="iddocumentfile" name="iddocumentfile" accept="image/*">
			</div>
			...
			<div class="mb-3">
				...
				<input type="text" class="form-control" id="postaddress" name="postaddress" required>
			</div>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	$sql = "INSERT INTO kyc_confirmation(subjectname, birthcountry, contactnumber, email, employeename, gender, iddocument, nationality,postaddress, occupation, dateofbirth, iddocumentfile) VALUES(?,?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
	if ($stmt = mysqli_prepare($link, $sql)) {
		mysqli_stmt_bind_param($stmt, "ssssssssssss", $name, $birthcountry, $contactnumber, $email, $employeename, $gender, $iddocument, $nationality, $postaddress, $occupation, $dateofbirth, $iddocumentfile);
